...
public class Vampire extends Creature implements Runnable{
    ...
    public Vampire(Handler handler,float x, float y) {
        ...
        //ANIMATIONS
        animIdle = new Animation(230,Assets.vampire_idle);
        animRunDown = new Animation(45,Assets.vampire_run_down);
        animRunLeft = new Animation(45,Assets.vampire_run_left);
        animRunRight = new Animation(45,Assets.vampire_run_right);
        animRunUp = new Animation(45,Assets.vampire_run_up);
        animSliceDown = new Animation(25,Assets.vampire_slice_down);
        animSliceLeft = new Animation(25,Assets.vampire_slice_left);
        animSliceRight = new Animation(25,Assets.vampire_slice_right);
        animSliceUp = new Animation(25,Assets.vampire_slice_up);
    ...
    @Override
    public void run() {
        handler.getWorld().getEntityManager().addVampire(handler, this);
